...
export default function SalesInvoiceBuilder() {
	...
	if (authLoading || loading)
		return (
			<div className='p-6 text-gray-900 bg-white min-h-screen flex items-center justify-center'>
	...
	return (
		<div className='p-6 text-gray-900 bg-white min-h-screen font-sans'>
			{/* HEADER */}
					...
					<div className='bg-white border border-gray-200 rounded-xl p-6 shadow-sm'>
						...
						<div className='space-y-3'>
							...
							<textarea
								...
								className='w-full p-2.5 bg-white border border-gray-300 rounded-lg focus:ring-2 focus:ring-blue-500 outline-none transition-all resize-none'
								rows={2}
							/>
						</div>
					</div>
					...
					<div className='bg-white border border-gray-200 rounded-xl p-6 shadow-sm'>
						...
						<div className='space-y-3'>
							<input
								...
								className='w-full p-2.5 bg-white border border-gray-300 rounded-lg focus:ring-2 focus:ring-green-500 outline-none transition-all'
							/>
							<input
								type='text'
							...
							<textarea
								...
								className='w-full p-2.5 bg-white border border-gray-300 rounded-lg focus:ring-2 focus:ring-green-500 outline-none transition-all resize-none'
								rows={2}
							/>
						</div>
					</div>
						...
						<div className='grid grid-cols-2 gap-3'>
							<div>
								...
								<input
									...
									className='w-full p-2.5 bg-white border border-gray-300 rounded-lg focus:ring-2 focus:ring-purple-500 outline-none transition-all'
								/>
							</div>
							<div>
								<label className='block text-xs font-bold text-gray-500 uppercase tracking-wider mb-1'>
							...
							<div>
								...
								<select
									...
									className='w-full p-2.5 bg-white border border-gray-300 rounded-lg focus:ring-2 focus:ring-purple-500 outline-none transition-all text-gray-900'>
					...
					<div className='bg-white border border-gray-200 rounded-xl p-6 shadow-sm'>
						...
						<div className='space-y-3'>
							<textarea
								...
								className='w-full p-2.5 bg-white border border-gray-300 rounded-lg focus:ring-2 focus:ring-yellow-500 outline-none transition-all resize-none'
								rows={3}
							/>
							<textarea
								...
								<tr
									...
									<td className='py-2'>
										<input
											...
											className='w-full p-2 bg-transparent border-b border-transparent group-hover:border-gray-200 focus:border-blue-500 outline-none transition-all'
										/>
									</td>
									<td className='py-3 px-2'>
										<input
											...
											className='w-full p-2 bg-white border border-gray-300 rounded-lg text-center focus:ring-2 focus:ring-blue-500 outline-none transition-all'
										/>
									</td>
									<td className='py-3 px-2'>
										<input
											...
											className='w-full p-2 bg-white border border-gray-300 rounded-lg text-right focus:ring-2 focus:ring-blue-500 outline-none transition-all'
										/>
									</td>
									<td className='py-3 px-2'>
										<input
